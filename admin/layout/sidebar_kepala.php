...
<div class="d-flex">
    ...
    <div id="sidebar" class="sidebar">
        ...
        <ul class="nav flex-column">
            <li><a href="dashboard_kepala.php" class="nav-link"><i class="bi bi-house-door"></i> <span>Home</span></a></li>
            <li><a href="kepala_kegiatan.php" class="nav-link"><i class="bi bi-journal-text"></i> <span>Kegiatan</span></a></li>
            <li><a href="laporan_kepala.php" class="nav-link"><i class="bi bi-journal-text"></i> <span>Laporan</span></a></li>
            <li><a href="index_kepala.php" class="nav-link text-white"><i class="bi bi-people-fill"></i> <span>Manajemen User</span></a></li>
        </ul>
